  ...
  const sections = [
    {
      ...
      content: "Khách hàng có thể đặt hàng trực tuyến thông qua Website hoặc Ứng dụng của MAY. Sau khi xác nhận đơn hàng, hệ thống sẽ gửi thông báo và bắt đầu chuẩn bị sản phẩm."
    },
    {
    ...
    },
    {
      ...
      icon: <FiTruck className="text-[#6c935b]" />,
      content: "MAY cam kết giao hàng trong vòng 15-30 phút tùy khoảng cách. Phí vận chuyển sẽ được tính dựa trên quãng đường từ cửa hàng gần nhất đến vị trí của khách hàng."
    },
    {
      title: "4. Hoàn trả và hủy đơn",
      icon: <FiRotateCcw className="text-red-500" />,
      content: "Quý khách có thể hủy đơn hàng trước khi cửa hàng bắt đầu chuẩn bị món. Trường hợp sản phẩm không đúng mô tả hoặc gặp vấn đề chất lượng, MAY sẽ hỗ trợ đổi trả hoặc hoàn tiền ngay lập tức."
    }
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6 mt-20">
      <div className="text-center mb-16">
        ...
        <p className="text-neutral-600">Những hướng dẫn và quy định giúp bạn có trải nghiệm mua sắm tốt nhất tại MAY.</p>
      </div>
      ...
      <div className="p-8 bg-neutral-100 rounded-3xl text-sm text-neutral-600 space-y-4">
        ...
        <p>- MAY có quyền từ chối các đơn hàng có dấu hiệu giả mạo hoặc không thể liên lạc được với người nhận.</p>
